...
Feature: Step 5
  ...
  @javascript
  Scenario: Testcase 22 a Moodle ≤ 4.0
  ...
  @javascript
  Scenario: Testcase 22 a Moodle ≥ 4.1
  ...
  Scenario: Testcase 22 b Moodle ≤ 4.0
    Given the site is running Moodle version 4.0 or lower
  ...
  @javascript @_switch_window @qtype_kprime_5_sc_22b
  Scenario: Testcase 22 b Moodle ≥ 4.1
    Given the site is running Moodle version 4.1 or higher
  # Change scoringmethod after test has been submitted
  # Check grades. Manual applied grades should not be overwritten
  ...
  Scenario: Testcase 22 c Moodle ≤ 4.0
    Given the site is running Moodle version 4.0 or lower
  ...
  @javascript @_switch_window
  Scenario: Testcase 22 c Moodle ≥ 4.1
    Given the site is running Moodle version 4.1 or higher
  # Change correct answer after test has been submitted.
  # Regrade the test and check the results
